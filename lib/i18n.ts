export const translations = {
  en: {
    ...
    genius: "Genius",
    lrclib: "LRCLIB",
    uploadMusics: "Upload Musics",
    uploadFile: "Upload BD.ini file",
    selectFile: "Select file",
    uploading: "Uploading...",
    uploadSuccess: "Upload successful",
    uploadError: "Upload failed",
    invalidFileType: "Invalid file type. Only .ini files are allowed",
  ...
  pt: {
    ...
    genius: "Genius",
    lrclib: "LRCLIB",
    uploadMusics: "Enviar Músicas",
    uploadFile: "Enviar arquivo BD.ini",
    selectFile: "Selecionar arquivo",
    uploading: "Enviando...",
    uploadSuccess: "Upload realizado com sucesso",
    uploadError: "Falha ao fazer upload",
    invalidFileType: "Tipo de arquivo inválido. Apenas arquivos .ini são permitidos",
    uploadStats: "Estatísticas do upload",
    sortBy: "Ordenar por",
    sortOrder: "Ordem",
    ascending: "Crescente",
